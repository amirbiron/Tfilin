...
class TestDatabaseManager:
    ...
    def test_get_user(self, db_manager, mock_client):
        ...
        # Setup mock response
        mock_user = {"user_id": 123456, "username": "testuser", "daily_time": "08:00", "is_active": True}
    ...
    def test_upsert_user_new(self, db_manager, mock_client):
        ...
        mock_client.tefillin_bot.users.update_one.return_value = Mock(upserted_id="new_id", modified_count=0)

        user_data = {"username": "newuser", "daily_time": "09:00", "timezone": "Asia/Jerusalem"}
    ...
    def test_upsert_user_existing(self, db_manager, mock_client):
        ...
        mock_client.tefillin_bot.users.update_one.return_value = Mock(upserted_id=None, modified_count=1)

        user_data = {"daily_time": "10:00"}
    ...
    def test_update_user(self, db_manager, mock_client):
        ...
        update_data = {"daily_time": "11:00", "sunset_reminder": True}
    ...
    def test_get_active_users(self, db_manager, mock_client):
        ...
        mock_users = [{"user_id": 1, "active": True}, {"user_id": 2, "active": True}]
    ...
    def test_get_users_by_time(self, db_manager, mock_client):
        ...
        mock_users = [{"user_id": 1, "daily_time": "08:00"}, {"user_id": 2, "daily_time": "08:00"}]
        mock_client.tefillin_bot.users.find.return_value = mock_users

        result = db_manager.get_users_by_time("08:00")

        assert result == mock_users
        mock_client.tefillin_bot.users.find.assert_called_once_with({"active": True, "daily_time": "08:00"})
